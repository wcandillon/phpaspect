...
class Point extends Shape {
    ...
    public function setY($y) {
        ...
        if (!function_exists('__phpaspect9eee2323d3e57c0ab19c5ccfeda3d7e6')) {
            function __phpaspect9eee2323d3e57c0ab19c5ccfeda3d7e6($thisJoinPoint) {
                echo $thisJoinPoint->getTarget();
            }
        }
        __phpaspect9eee2323d3e57c0ab19c5ccfeda3d7e6($thisJoinPoint);
        unset($thisJoinPoint);
        return $__return_result;
    }
