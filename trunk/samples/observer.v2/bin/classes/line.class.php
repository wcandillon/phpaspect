...
class Line extends Shape {
    ...
    public function setP2(Point $p2) {
        ...
        if (!function_exists('__phpaspect120911725abb58ab83a184cb509b1b7a')) {
            function __phpaspect120911725abb58ab83a184cb509b1b7a($thisJoinPoint) {
                echo $thisJoinPoint->getTarget();
            }
        }
        __phpaspect120911725abb58ab83a184cb509b1b7a($thisJoinPoint);
        unset($thisJoinPoint);
        return $__return_result;
    }
